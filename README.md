...
The original project found that incorporating MICOM-derived metabolic features substantially improved classification performance compared to using taxonomic composition alone. Full methodology, results, and discussion are available in [final report](https://github.com/haniya-naeem/AD-Microbiome-ML-Classification/blob/main/Project%20Report_ENGG680_Group%2010.pdf)
